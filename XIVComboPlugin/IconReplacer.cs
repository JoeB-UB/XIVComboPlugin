            ...
            */
            ...
            if (Configuration.ComboPresets.HasFlag(CustomComboPreset.RedMageVerprocCombo))
            {
                if (actionID == RDM.Verstone)
                {
                    ...
                    if (SearchBuffArray(RDM.BuffVerstoneReady)) return RDM.Verstone; //should do nothing because of above code
                ...
                if (actionID == RDM.Verfire)
                {
                    ...
                    if (SearchBuffArray(RDM.BuffVerfireReady)) return RDM.Verfire; //should do nothing because of above code
                    if (level < 62) return RDM.Jolt;
                    return RDM.Jolt2;
                }
